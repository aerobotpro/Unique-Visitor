...
class user:
    class settings:
        try:
            ...
            print(str(EEE))
        max_fails = 1500 #<<<<#################################################################<<<<<<<<<<MAX Failed Requests Allowed<<<<<<<<<<<<||||||||||||||||||||||||||||||||||||||||||||||
...
def startup_print():
    sleep(.2);print("<-------------------|>\r", end="");sleep(.2);print("<-------------------\\>\r", end="");sleep(.2);print("<------------------_->\r", end="");sleep(.2);print("<----------------/--->\r", end="");sleep(.2);print("<--------------|----->\r", end="");sleep(.2);print("<------------\\------->\r", end="");sleep(.2);print("<----------_--------->\r", end="");sleep(.2);print("<-------/------------>\r", end="");sleep(.2);print("<----|--------------->\r", end="")
    sleep(.2);print("<---\\---------------->\r", end="");sleep(.2);print("<--_----------------->\r", end="");sleep(.2);print("<-/------------------>\r", end="");sleep(.2);print("<|------------------->\r", end="");sleep(.2);print("<\\------------------->\r", end="");sleep(.2);print("<_------------------->\r", end="");sleep(.2);print("</------------------->\r", end="");sleep(.2);print("<|------------------->\r", end="");sleep(.2);print("<\\------------------->\r", end="")
    sleep(.2);print("<_------------------->\r", end="");sleep(.2);print("</------------------->\r", end="");sleep(.2);print("<|------------------->\r", end="");sleep(.2);print("<-/------------------>\r", end="");sleep(.2);print("<--_----------------->\r", end="");sleep(.2);print("<---\\---------------->\r", end="");sleep(.2);print("<----|--------------->\r", end="");sleep(.2);print("<-------/------------>\r", end="");sleep(.2);print("<----------_--------->\r", end="")sleep(.2)
    print("<------------\\------->\r", end="");sleep(.2);print("<--------------|----->\r", end="");sleep(.2);print("<--------------/----->\r", end="");sleep(.2);print("<--------------_----->\r", end="");sleep(.2);print("<--------------\\----->\r", end="");sleep(.2);print("<-----------------|-->\r", end="");sleep(.2);print("<------------------/->\r", end="");sleep(.2);print("<-------------------_>\r", end="");sleep(.2);print("<-------------------\\>\r", end="");sleep(.2)
    print("<-------------------|>\r", end="")
